...
write_delim(
  x = assembly_stats,
  file = snakemake@output[["assembly_stats"]],
  delim = "\t"
)
...
rm(
  arg_stats, arg_results, match_results_with_stats, annotated_args, arg_annotation,
  classified_args,
...
write_delim(
  x = classifications,
  file = snakemake@output[["taxonomic_classification"]],
  delim = "\t"
)
...
write_delim(
  ...
  file = snakemake@output[["plasmid_prediction"]],
  delim = "\t"
)
...
write_delim(
  ...
  file = snakemake@output[["virus_prediction"]],
  delim = "\t"
)
...
write_csv(
  ...
  file = snakemake@output[["assembly_database"]],
)
